...
if (path.endsWith("ARCHITECTURE.md")) {
  reminders.push(
    "ℹ  Changing ARCHITECTURE.md: update scripts/check-structure.mjs to match if boundaries move.",
  );
}
if (path.endsWith("CLAUDE.md")) {
  reminders.push(
    "ℹ  Changing CLAUDE.md: this is the agent briefing — keep rules short and enforceable.",
  );
}
...
if (/^docs\/decisions\//.test(path) || /docs\/decisions\//.test(path)) {
  reminders.push(
    "ℹ  Writing an ADR: never delete existing ADRs. Use 'Superseded by NNNN' instead.",
  );
}
